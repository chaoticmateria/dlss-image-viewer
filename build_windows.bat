...
echo ================================================================
echo DLSS Image Viewer V11 - Windows x64 D3D12 / NGX / FFmpeg
echo ================================================================
...
if not exist "build\Release\DLSSImageViewer.exe" (
...
if errorlevel 1 (
    echo [ERROR] Could not copy FFmpeg beside DLSSImageViewer.exe.
    pause
    exit /b 1
)
...
echo.
echo ================================================================
echo [OK] build\Release\DLSSImageViewer.exe
